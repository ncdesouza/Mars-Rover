...
import Direction, { North, South, West, East } from "../direction";
...
describe('Move method', () => {
    it('Test move North', () => {
        ...
        expect(positionAfterMove).to.eql([0, 1]);
    });
    it('Test move South', () => {
    ...
    it('Test move East', () => {
        ...
        const positionAfterMove = position.move(direction);
        expect(positionAfterMove).to.eql([1, 0]);
    });
    it('Test move West', () => {
    ...
    it('Test move North with magnitude', () => {
        ...
        expect(positionAfterMove).to.eql([0, 2]);
    });
    ...
    it('Test move East with magnitude', () => {
        ...
        const direction : Direction = new East();
        const positionAfterMove = position.move(direction, 2);
        expect(positionAfterMove).to.eql([2, 0]);
    });
